...
/** A level three builder that constructs the elements of a push sheep manager. */
public class Level3Builder implements Game3Builder {
  ...
  /**
   * Constructs a new level three builder.
   *
   * @param manager the push sheep manager where the builder is used.
   */
  Level3Builder(Game3Manager manager) {
  ...
  public void buildSheep(Context context) {
    ...
    sheeps.add(
        new Sheep(new Rect(3 * scale, 3 * scale, 4 * scale, 4 * scale), manager, context, "3"));
    sheeps.add(
        new Sheep(new Rect(6 * scale, 6 * scale, 7 * scale, 7 * scale), manager, context, "3"));
    sheeps.add(
        new Sheep(new Rect(4 * scale, 12 * scale, 5 * scale, 13 * scale), manager, context, "3"));

    sheeps.add(
        new Sheep(new Rect(7 * scale, 16 * scale, 8 * scale, 17 * scale), manager, context, "3"));

    sheeps.add(
        new Sheep(new Rect(8 * scale, 18 * scale, 9 * scale, 19 * scale), manager, context, "3"));

    sheeps.add(
        new Sheep(new Rect(4 * scale, 16 * scale, 5 * scale, 17 * scale), manager, context, "3"));

    sheeps.add(
        new Sheep(new Rect(7 * scale, 13 * scale, 8 * scale, 14 * scale), manager, context, "3"));
  ...
  public void buildSewers(Context context) {
    ...
    sewers.add(new Sewer(new Rect(3 * scale, 23 * scale, 13 * scale, 24 * scale), context));
    sewers.add(new Sewer(new Rect(3 * scale, 12 * scale, 4 * scale, 24 * scale), context));
    sewers.add(new Sewer(new Rect(3 * scale, 11 * scale, 13 * scale, 12 * scale), context));
    sewers.add(new Sewer(new Rect(12 * scale, 12 * scale, 13 * scale, 22 * scale), context));
