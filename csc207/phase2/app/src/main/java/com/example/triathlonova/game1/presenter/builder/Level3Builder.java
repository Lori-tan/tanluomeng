...
class Level3Builder extends GameBuilder implements Game1Builder {
  ...
  /**
   * Initialize some stairs (based on level3 map) under this context and return a list containing
  ...
  public List<Stairs> buildStairs(Context context) {
    ...
    Stairs stairs1 = new Stairs(100, 300, 1, 1, context);
    stairsList.add(stairs1);
    Stairs stairs2 = new Stairs(300, 1000, 1, 1, context);
    stairsList.add(stairs2);
    Stairs stairs3 = new Stairs(0, 1375, 1, 1, context);
    stairsList.add(stairs3);
    Stairs stairs4 = new Stairs(800, 750, 1, 1, context);
  ...
  public List<Gem> buildGem(Context context) {
    ...
    Gem gem1 = new Gem(new Rect(150, 200, 200, 250), context);
    gemList.add(gem1);
    return gemList;
  }

  /**
   * Initialize some hearts (based on level3 map) under this context and return a list containing
  ...
  public List<Hearts> buildHearts(Context context) {
    ...
    Hearts hearts1 = new Hearts(new Rect(850, 650, 900, 700), context);
  ...
  public Bitmap buildBackground(Context context) {
    return BitmapFactory.decodeResource(context.getResources(), R.drawable.game1_roof);
  }
}
